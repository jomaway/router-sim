...
<template>
  ...
  <main-section>
    ...
    >
      Connected to Network on {{wan.ip}}
    </notification>
    ...
    >
      <field label="Wan Connection Type" help="choose dynamic ip if not sure!">
        <control
      ...
      <div v-if="isStatic">
        ...
        <field label="Wan IP">
          <control v-model="wan.ip" />
        </field>
        <field label="Subnetmask">
          <control v-model="wan.subnetmask" />
        </field>
        <field label="Gateway">
          <control v-model="wan.gateway" />
        </field>
